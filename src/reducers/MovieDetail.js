import {
  ...
  GET_MOVIE_DETAIL_REQUESS, GET_MOVIE_DETAIL_SUCCESS, GET_MOVIE_DETAIL_FAIL,
...
const movieDetailReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case GET_MOVIE_DETAIL_REQUESS: {
      return { ...state, loadingMovieDetail: true, errorMovieDetail: null, };
    }
